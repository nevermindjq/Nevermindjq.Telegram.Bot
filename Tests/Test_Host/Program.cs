...
using Nevermindjq.Telegram.Bot.Database.Commands;
...
builder.Services.AddScoped<IRegisterCommand, RegisterCommand>(x => new RegisterCommand(x.GetRequiredService<ITelegramBotClient>(), x.GetRequiredService<UsersDbContext>()));
